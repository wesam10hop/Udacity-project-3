...
${frame.code}`;
    ...
    cykiM: [
      function (require, module, exports, __globalThis) {
        ...
        const renderCardSetsPage = () => {
          ...
          const pageHeader = (0, _utilityRenderFunctionsJs.createHeader)(
            "h2",
            "Study Set Library",
            "study-set-header",
          );
          ...
          const toggleFormButton = (0,
          _utilityRenderFunctionsJs.createToggleButton)("Add New Set", form);
        ...
        const createCardSets = () => {
          ...
          (0, _dataJs.cardSets).forEach((set) =>
            createSetPreviewCard(set, setContainer),
          );
          return setContainer;
        };
      },
      {
        ...
        "./cardsPage.js": "fMRv2",
        "./createSet.js": "60GGE",
        "./utilityRenderFunctions.js": "7Z6eA",
    ...
    fMRv2: [
      function (require, module, exports, __globalThis) {
        ...
        const renderFlashCards = (set, index = 0) => {
          ...
          const addCardBtn = (0, _utilityRenderFunctionsJs.createToggleButton)(
            "Add New Card",
            form,
          );
    ...
    "92YE4": [
      function (require, module, exports, __globalThis) {
        ...
        const renderCardForm = (set) => {
          ...
          const h3 = (0, _utilityRenderFunctionsJs.createHeader)(
            "h3",
            "Create Cards",
            "create_cards",
          );
          ...
          const termLabel = (0, _utilityRenderFunctionsJs.createLabel)(
            "Term",
            "termInput",
          );
          // Creates input for the term
          const termInput = (0, _utilityRenderFunctionsJs.createInput)(
            "termInput",
          );
          // Creates label for description
          const descriptionLabel = (0, _utilityRenderFunctionsJs.createLabel)(
            "Description",
            "descriptionInput",
          );
          // Creates input for description
          const descriptionInput = (0, _utilityRenderFunctionsJs.createInput)(
            "descriptionInput",
          );
          //Creates submit input
          const addCardBtn = (0, _utilityRenderFunctionsJs.createSubmitButton)(
            "Add Card",
          );
          ...
          cardForm.addEventListener("submit", (e) => {
            ...
            if (!term && !description)
              (0, _errorsJs.showError)("Error: Front and Back cannot be empty");
            else if (!term)
              (0, _errorsJs.showError)("Error: Front cannot be empty");
            else if (!description)
              (0, _errorsJs.showError)("Error: Back cannot be empty");
    ...
    "60GGE": [
      function (require, module, exports, __globalThis) {
        ...
        const createSetForm = (setCards) => {
          ...
          const label = (0, _utilityRenderFunctionsJs.createLabel)(
            "Card Set Title",
            "titleInput",
          );
          // Creates the input fot the title
          const input = (0, _utilityRenderFunctionsJs.createInput)(
            "titleInput",
          );
          const submitButton = (0,
          _utilityRenderFunctionsJs.createSubmitButton)("Submit Set");
        ...
        const submitSet = (e, setCards) => {
          ...
          if (!title)
            (0, _errorsJs.showError)("Error: Set name cannot be empty");
          else {
            //Creates set object
            const id = setCards.length
              ? setCards[setCards.length - 1].id + 1
              : 1;
            //Adds set data
            setCards.push({
              id,
    ...
    aRpDC: [
      function (require, module, exports, __globalThis) {
        ...
        var _aboutImagePngDefault =
          parcelHelpers.interopDefault(_aboutImagePng);
        ...
        const renderAboutPage = () => {
          ...
          const heading = (0, _utilityRenderFunctionsJs.createHeader)(
            "h2",
            "About Study Night",
            "about_page",
          );
          // Create and set up the subheading
          const subHeading = (0, _utilityRenderFunctionsJs.createElement)(
            "h3",
            "Flash Cards Anywhere Anytime",
          );
          ...
          const aboutP = (0, _utilityRenderFunctionsJs.createElement)(
            "p",
            text,
          );
          // Create and set up the image
          const aboutImage = (0, _utilityRenderFunctionsJs.createImage)(
            (0, _aboutImagePngDefault.default),
            "Child Studying",
          );
    ...
    aAmIa: [
      function (require, module, exports, __globalThis) {
        ...
        const renderHomePage = () => {
          ...
          const header = (0, _utilityRenderFunctionsJs.createHeader)(
            "h1",
            "Study Night",
            "home_header",
          );
          ...
          //Creates elements
          const image = (0, _utilityRenderFunctionsJs.createImage)(
            (0, _homePagePngDefault.default),
            "Desk of laptops",
          );
          ...
          const setForm = (0, _createSetJs.createSetForm)(
            (0, _dataJs.cardSets),
          );
          const toggleFormButton = (0,
          _utilityRenderFunctionsJs.createToggleButton)("Add New Set", setForm);
          toggleFormButton.setAttribute("data-cy", "toggle_form");
          ...
          const addCardContainer = (0, _createCardJs.renderCardForm)(
            (0, _dataJs.cardSets)[0].cards,
          );
